...
**If codebase exists, use Task tool with `subagent_type="ContextScout"`:**
...
**If no codebase, use Task tool with `subagent_type="ExternalScout"`:**
...
│  (ExternalScout for web, ContextScout for codebase)    │
└─────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────┐
