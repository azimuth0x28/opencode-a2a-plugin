...
| Agent names | `lowercase` | `a2a`, `bootstrapper`, `probe` |
...
export { a2aAgent, bootstrapperAgent, probeAgent };
```
...
- Prefix with `[a2a]` for identification

```typescript
console.error("[a2a] Failed to parse WebSocket message:", error);
```
